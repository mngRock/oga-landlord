...
export default async function LandlordDashboard() {
  ...
  const { data: dashboardData } = await supabase.rpc('get_landlord_dashboard_data');
  ...
  const recentActivities: {id: string, message: string, created_at: string}[] = dashboardData?.recent_activities || [];
